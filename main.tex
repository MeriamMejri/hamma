...
% Change Chapter and Contents titles
\addto\captionsfrench{\renewcommand{\chaptername}{Chapitre}} % Change 'Chapter' to 'Chapitre'
\renewcommand{\contentsname}{Table de matières} % Change 'Contents' to 'Table de matières'
...
% \input{chapter/Chapitre_1}

% \input{chapter/Chapitre_2}

% \input{chapter/Chapitre_3}

% \input{chapter/Chapitre_4}
...
% Initialize the minitocs
\dominitoc % Activate minitoc for the whole document

% Add signatures
\noindent
\begin{center}
    {\LARGE \textbf{Signature du superviseur académique de l'université}}
\end{center}
\vspace{0.5cm}
\begin{center}
\begin{tikzpicture}
...
\noindent
\begin{center}
    {\LARGE \textbf{Signature du superviseur en entreprise}}
\end{center}
\vspace{0.5cm}
\begin{center}
\begin{tikzpicture}
...
% Add Resume before List of Abbreviations
\input{chapter/Resume}

% List of Abbreviations
\input{chapter/03-ListOfAbr}

% Chapters with mini-tocs
\newpage
\pagenumbering{arabic}

\minitoc % Mini-table of contents for this chapter
\input{chapter/Chapitre_1}
...
% Appendices
\input{chapter/09-AnnexeA}
\input{chapter/09-AnnexeB}
